@extends('layouts.navigations-workspace')
...
<div id="content">
        ...
        <p class="price hidden">0.00</p>
            ...
            <div class="container new-container">
                        ...
                        <div id="layout" class="tab-pane fade">
                            <ul>
                                ...
                                <li class="side-wrapper1">
                                    <p>Graduation Theme Layout Coming Soon</p>
                                </li>   
                                ...
                                <ul>
                                    ...
                                    ?>
                                        <li id="T1" class="L_li hidden">
                                            <img id="drag{{$background_counter}}" class="dragbg_l hidden" src="{{$background->user_themebackgroundsrc}}" draggable="true" ondragstart="drag(event)" >
                                        </li>
                                        <?php 
                                            }
                                             if($background_counter>10){
                                        ...
                                        <li id="T1" class="P_li hidden">
                                            <img id="drag{{$background_counter}}" class="dragbg_p hidden" src="{{$background->user_themebackgroundsrc}}" draggable="true" ondragstart="drag(event)" >
                                        </li>
                                    <?php }} ?>
                                </ul>
                            </div>
                ...
                <!-- <h3>BORDERS</h3> [drag21-drag40]-->
                            <div id="border" class="tab-pane fade">
                                <ul>
                                    ...
                                    ?>
                                        <li id="T1" class="L_li hidden">
                                            <img id="drag{{$border_counter}}" class="dragbg_l hidden" src="{{$border->user_themebordersrc}}" draggable="true" ondragstart="drag(event)" >
                                        </li>
                                        <?php 
                                            }
                                             if($border_counter>30){
                                        ?>
                                        <li id="T1" class="P_li hidden">
                                            <img id="drag{{$border_counter}}" class="dragbg_p hidden" src="{{$border->user_themebordersrc}}" draggable="true" ondragstart="drag(event)" >
                                        </li>
                                    <?php }} ?>
                                </ul>
                            </div>
                ...
                <div class="panel-heading-navigation-side">
                    <p class="restriction hidden">ViewAndEdit</p>
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <!-- RESET SCRAPBOOK DIV -->
                            <li>
                            <button id="reset"  class="button_reset" onclick="resetScrapbook();" value="Reset" ng-click="AddT.$rollbackViewValue(); name=''"/>RESET <br> PAGE</button>
                            </li>
                            <!-- RESET SCRAPBOO DIV -->
                        </ul> 
                        <!-- SCRAPBOOK NAVIGATIONS --> 
                ...
                <!-- <div id="panel-defaultsidebar-menu-2"> -->
                           <!-- WORKSPACE -->
                            <div class="box2" id="details">
                                <!-- EDIT TITLE -->
                                <li class="scrap_id hidden"><p id="scrapbookid" class="scrap_id hidden"> </p></li>

                                <p id="scrapbookpagesid" class="scrappages_id hidden" > </p>

                                </li><div class="scrap_title hidden">
                                
                                <h2 id="saved_title" class="saved_title">Title: </h2>
