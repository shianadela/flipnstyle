        ...
        $(objName).removeClass("drag");
          ...
          $(objName).draggable({
            ...
            stop:function(ev, ui) {
                ...
                var user_scrapbookpagesid = $('#scrapbookpagesid_pageL'+PageNumber).text();  
                            ...
                            if(getBASE == true){
                              ...
                              $.ajax({ 
                                  ...
                                  success: function(data) { 
                                    ...
                                    $("#deleteIMG"+counter).attr({ id:"deleteIMG"+elementid, onClick:"DeleteLoadedEmblems_L('"+deleteIMG_id+"','"+elementvalue+"','"+spid+"')" });
...
// DELETE EMBELLISHMENT
  function DeleteLoadedEmblems_L( span,elementvalue,spid ){
...
// ADD PAGE AND ADD TEXT INPUT
 pagecounter = $('#pagenumber_savedL').text();
