...
@section('content')
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-4">
                        <h2 class="hello_designer">Welcome!</h2>
                    <div class="boxlogin">
                        <h3>Log-In</h3>

            <form  role="form" method="post" action="admin/dashboard" name="DesignerForm">

                 <div class="form-group{{ $errors->has('designerid') ? ' has-error' : '' }}">
                    <label for="id">Admin ID</label>
                    <input type="text" name="adminid" class="form-control" id="designerid" value="">
                </div>
