...
<div class="navbar navbar-default yamm" role="navigation" id="navbar">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand home" href="{{ url('admin/index') }}" data-animate-hover="bounce">
        ...
        <div class="navbar-collapse collapse" id="navigation">
            ...
            <ul class="nav navbar-nav navbar-left">
                <li><a href="{{ url('admin/index') }}" data-hover="dropdown">Home</a>
                </li>
                <li class="dropdown yamm-fw">
                    <a href="{{ url('admin/submissions') }}" data-hover="dropdown">Submissions</a>
                </li>
                <li class="dropdown yamm-fw">
                    <a href="{{ url('admin/purchases') }}" data-hover="dropdown">Purchases</a>
                </li>
           </ul>
        </div>
    </div>
